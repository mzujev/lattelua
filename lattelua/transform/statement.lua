local Transformer
Transformer = require("lattelua.transform.transformer").Transformer
local NameProxy, LocalName, is_name_proxy
do
  local _obj_0 = require("lattelua.transform.names")
...
do
  local _obj_0 = require("lattelua.transform.statements")
...
local types = require("lattelua.types")
...
local insert
insert = table.insert
local destructure = require("lattelua.transform.destructure")
local construct_comprehension
construct_comprehension = require("lattelua.transform.comprehension").construct_comprehension
local unpack
...
return Transformer({
  ...
  ["return"] = function(self, node)
    ...
    if ret_val_type == "chain" or ret_val_type == "comprehension" or ret_val_type == "tblcomprehension" then
      local Value = require("lattelua.transform.value")
  ...
  class = require("lattelua.transform.class")
})
