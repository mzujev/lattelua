...
local debug_posmap
debug_posmap = function(posmap, latte_code, lua_code)
  local tuples
  do
    local _accum_0 = { }
    local _len_0 = 1
  ...
  do
    ...
    for _index_0 = 1, #tuples do
      ...
      local latte_line = pos_to_line(latte_code, pos)
      local lua_text = get_line(lua_code, lua_line)
      local latte_text = get_closest_line(latte_code, latte_line)
      local _value_0 = tostring(pos) .. "\t " .. tostring(lua_line) .. ":[ " .. tostring(trim(lua_text)) .. " ] >> " .. tostring(latte_line) .. ":[ " .. tostring(trim(latte_text)) .. " ]"
