local util = require("lattelua.util")
local dump = require("lattelua.dump")
local transform = require("lattelua.transform")
...
local Set
Set = require("lattelua.data").Set
local ntype, value_can_be_statement
do
  local _obj_0 = require("lattelua.types")
  ntype, value_can_be_statement = _obj_0.ntype, _obj_0.value_can_be_statement
end
local statement_compilers = require("lattelua.compile.statement")
local value_compilers = require("lattelua.compile.value")
local concat, insert
do
  local _obj_0 = table
...
do
  local data = require("lattelua.data")
